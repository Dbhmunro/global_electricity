...
# require_all './global_access/'
require_relative './global_access/cli'
require_relative './global_access/country'
require_relative './global_access/internet_access'
...
require_relative './global_access/version'
